...
public class ModItems {
    ...
    public static final Item LIGHT_BLUE_BLAHAJ = registerItem("light_blue_blahaj", new Item(new Item.Settings().maxCount(1).rarity(Rarity.COMMON)));
    public static final Item YELLOW_BLAHAJ = registerItem("yellow_blahaj", new Item(new Item.Settings().maxCount(1).rarity(Rarity.COMMON)));
    public static final Item LIME_BLAHAJ = registerItem("lime_blahaj", new Item(new Item.Settings().maxCount(1).rarity(Rarity.COMMON)));
    public static final Item PINK_BLAHAJ = registerItem("pink_blahaj", new Item(new Item.Settings().maxCount(1).rarity(Rarity.COMMON)));
    public static final Item GRAY_BLAHAJ = registerItem("gray_blahaj", new Item(new Item.Settings().maxCount(1).rarity(Rarity.COMMON)));
    public static final Item LIGHT_GRAY_BLAHAJ = registerItem("light_gray_blahaj", new Item(new Item.Settings().maxCount(1).rarity(Rarity.COMMON)));
    public static final Item CYAN_BLAHAJ = registerItem("cyan_blahaj", new Item(new Item.Settings().maxCount(1).rarity(Rarity.COMMON)));
    public static final Item PURPLE_BLAHAJ = registerItem("purple_blahaj", new Item(new Item.Settings().maxCount(1).rarity(Rarity.COMMON)));
    public static final Item BLAHAJ = registerItem("blahaj", new Item(new Item.Settings().maxCount(1).rarity(Rarity.COMMON)));
    public static final Item BROWN_BLAHAJ = registerItem("brown_blahaj", new Item(new Item.Settings().maxCount(1).rarity(Rarity.COMMON)));
    public static final Item GREEN_BLAHAJ = registerItem("green_blahaj", new Item(new Item.Settings().maxCount(1).rarity(Rarity.COMMON)));
    public static final Item RED_BLAHAJ = registerItem("red_blahaj", new Item(new Item.Settings().maxCount(1).rarity(Rarity.COMMON)));
    public static final Item BLACK_BLAHAJ = registerItem("black_blahaj", new Item(new Item.Settings().maxCount(1).rarity(Rarity.COMMON)));
