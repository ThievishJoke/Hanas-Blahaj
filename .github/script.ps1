...
$apiUrl = "https://api.modrinth.com/v2/project/H6WETF49/version"
...
$headers = @{
    "User-Agent" = "ThievishJoke/Hanas-Blahaj (GitHub Actions)"
}
...
if ($version_id -ne $previous_version_id) {
    ...
    $url = "https://modrinth.com/datapack/hanas-blahaj/version/$version_id"
